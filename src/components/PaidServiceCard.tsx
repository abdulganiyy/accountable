...
const PaidServiceCard: FC<PaidServiceCardProps> = ({ item }) => {
  const {
    status = item?.active
      ? "active"
      : item?.expired
  ...
  return (
    <div className="px-5 py-6 border-[#E6E6E6] border-[1px] rounded-[16px] bg-white">
